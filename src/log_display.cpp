...
{
    height_property_ = new rviz_common::properties::IntProperty("height", 200, "window height", this, SLOT(renderOverlay()));
    width_property_ = new rviz_common::properties::IntProperty("width", 400, "window width", this, SLOT(renderOverlay()));
    size_property_ = new rviz_common::properties::IntProperty("size", 16, "window size", this, SLOT(renderOverlay()));
...
// void LogDisplay::processMessage(const rcl_interfaces::msg::Log& msg)
void LogDisplay::processMessage(rcl_interfaces::msg::Log::ConstSharedPtr msg)
{
    if (msg->level == rcl_interfaces::msg::Log::DEBUG)
        return;
...
void LogDisplay::renderOverlay()
{
    ...
    {
        if (log_msgs_[i].level == rcl_interfaces::msg::Log::FATAL || log_msgs_[i].level == rcl_interfaces::msg::Log::ERROR)
            text_elements_[i]->setColour(Ogre::ColourValue::Red);
        else if (log_msgs_[i].level == rcl_interfaces::msg::Log::WARN)
...
PLUGINLIB_EXPORT_CLASS(sample_rviz_plugins::LogDisplay, rviz_common::Display)